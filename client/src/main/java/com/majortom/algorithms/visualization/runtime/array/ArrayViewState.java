...
public record ArrayViewState(
        List<VisualValue> values, Mutation mutation, Observation observation, boolean completed) {
    ...
    public record Observation(
            ObservationType type, int firstIndex, int secondIndex, VisualValue comparedValue) {
        public Observation {
            Objects.requireNonNull(type, "type");
        }
        ...
        public static Observation comparedValue(int index, Object value) {
            return new Observation(
                    ObservationType.COMPARED_VALUE, index, -1, VisualValue.of(value));
        }
    }
