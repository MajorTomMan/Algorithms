...
/**
 * FX-thread-only bridge between the generic render runtime and one visual surface. Implementations
 * may touch JavaFX nodes only because every method is invoked by FxExecutor.
 */
