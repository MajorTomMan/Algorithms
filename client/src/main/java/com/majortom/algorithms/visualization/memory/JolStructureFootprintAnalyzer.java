...
/** Optional JOL adapter loaded reflectively so ordinary/offline builds keep no hard dependency. */
public final class JolStructureFootprintAnalyzer {
    private static final String GRAPH_LAYOUT = "org.openjdk.jol.info.GraphLayout";
    private static final JolStructureFootprintAnalyzer SHARED = new JolStructureFootprintAnalyzer();
    ...
    public static JolStructureFootprintAnalyzer shared() {
        return SHARED;
    }

    private JolStructureFootprintAnalyzer() {
        Class<?> type = null;
        Method parse = null;
        Method size = null;
        Method count = null;
    ...
    private StructureFootprint measure(Object root) {
        try {
            ...
            return StructureFootprint.unavailable(Objects.toString(cause.getMessage(), cause.getClass().getSimpleName()));
        }
    }
