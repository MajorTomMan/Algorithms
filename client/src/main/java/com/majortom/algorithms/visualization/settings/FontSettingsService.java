...
public final class FontSettingsService {
  public enum LayoutTier { NORMAL, LARGE, XLARGE }
  ...
  private static final List<String> FONT_STYLESHEETS =
      List.of("/style/typography.css", "/style/font-settings.css", "/style/workbench-layout.css");
  ...
  private String projectDefaultChineseFamily() {
    return firstAvailableFamily(List.of("Microsoft YaHei", "Microsoft YaHei UI", "Noto Sans CJK SC",
        "Noto Sans CJK JP", "Source Han Sans SC", "PingFang SC", "SimSun", "Arial Unicode MS"));
  }

  private String projectDefaultEnglishFamily() {
    return firstAvailableFamily(
        List.of("Segoe UI", "Arial", "Noto Sans", "DejaVu Sans", "Liberation Sans", "Consolas"));
  }
  ...
  private boolean managedDeclaration(String declaration) {
    return declaration.startsWith("-fx-font-family:") || declaration.startsWith("-fx-font-size:")
