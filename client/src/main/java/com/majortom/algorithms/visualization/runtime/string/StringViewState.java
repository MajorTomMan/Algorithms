...
public record StringViewState(
    String value, Mutation mutation, Observation observation, int patternStart, boolean completed) {
  ...
  public enum Type { NONE, INSERTED, REMOVED, UPDATED, REPLACED }

  public enum ObservationType { NONE, COMPARED, MATCHED, FALLBACK }
}
