...
public record ProblemDescriptor(ProblemSource source, String id, String name, String number,
    ProblemDifficulty difficulty, java.util.List<String> tags, Class<?> implementation,
    Method entryPoint) {
