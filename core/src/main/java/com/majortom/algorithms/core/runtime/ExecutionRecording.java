...
public record ExecutionRecording(String runId, String operationId, ExecutionRecordingState state,
    ExecutionStatistics statistics, ExecutionSummary summary, List<EventEnvelope> events) {
  /** Creates a recording with event-derived timing and no host measurements. */
  public ExecutionRecording(String runId, String operationId, ExecutionRecordingState state,
      ExecutionStatistics statistics, List<EventEnvelope> events) {
  ...
  private static void validate(String runId, String operationId,
      ExecutionRecordingState expectedState, ExecutionStatistics statistics,
