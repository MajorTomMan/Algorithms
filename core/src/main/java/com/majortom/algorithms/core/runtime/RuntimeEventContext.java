...
final class RuntimeEventContext {
  ...
  RuntimeEventContext(String runId, String operationId, String source, EventSink eventSink,
      RunControl runControl, Clock clock) {
  ...
  private enum Permission { START, DOMAIN, COMPLETION }
