 ...
 */
public record ExecutionSummary(ExecutionStatistics statistics, OptionalLong inputSize,
    ExecutionTiming timing, ResourceUsage resources) {
  ...
  public static ExecutionSummary empty() {
    return new ExecutionSummary(ExecutionStatistics.empty(), OptionalLong.empty(),
        ExecutionTiming.eventOnly(java.time.Duration.ZERO), ResourceUsage.empty());
  }
  ...
  public static ExecutionSummary from(ExecutionStatistics statistics) {
    ...
    return new ExecutionSummary(statistics, OptionalLong.empty(),
        ExecutionTiming.eventOnly(statistics.eventSpan()), ResourceUsage.empty());
  }
