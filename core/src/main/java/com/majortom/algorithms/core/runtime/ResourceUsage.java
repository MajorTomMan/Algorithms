 ...
 *
 * <p>The values are optional because a runtime may not expose a particular counter. The core model
 * deliberately does not prescribe how a client or server obtains these measurements.
 */
public record ResourceUsage(
        OptionalLong cpuTimeNanos, OptionalLong peakMemoryBytes, OptionalLong outputBytes) {
    ...
    public static ResourceUsage empty() {
        return new ResourceUsage(OptionalLong.empty(), OptionalLong.empty(), OptionalLong.empty());
    }
