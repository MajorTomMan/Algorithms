...
@Algorithm(id = "insertion-sort", name = "Insertion Sort", type = String.class,
  ...
  public void sort(ArrayStructure<String> array) {
    for (int insertionIndex = 1; insertionIndex < array.size(); insertionIndex++) {
      ...
      while (scanIndex >= 0) {
        ...
        AlgorithmEvents.compared(ArrayObservationDomains.INDEX_SOURCE, scanIndex, insertionValue);
