...
public abstract class Example {
    ...
    public static Treenode<Integer> buildTree(Integer[] nums,int index){ 
    ...
    private static void writeArray(Treenode<Integer> currNode, int rowIndex, int columnIndex, String[][] res, int treeDepth) {
        // 保证输入的树不为空
