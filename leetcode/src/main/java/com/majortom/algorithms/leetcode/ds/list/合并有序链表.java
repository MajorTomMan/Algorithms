...
public class 合并有序链表 {
    public static void main(String[] args) {
        ...
        ListNode<Integer> head_1 = AlgorithmsUtils.buildLinkedList(nums_1),
                head_2 = AlgorithmsUtils.buildLinkedList(nums_2);
        ListNode<Integer> result = mergeTwoLists(head_1, head_2);
        AlgorithmsUtils.printList(result);
    }

    public static ListNode<Integer> mergeTwoLists(
            ListNode<Integer> list1, ListNode<Integer> list2) {
        if (list1 == null) {
            return list2;
        } else if (list2 == null) {
            return list1;
